...
moving it earlier or later in time, or you can stretch (or shrink) the range to match two timing points.""")
                ...
                , ( "start absolute", """Recorded time at start: """)
                , ( "end absolute", """Recorded time at end: """)
                , ( "start relative", """Ride time at start: """)
                , ( "end relative", """Ride time at end: """)
                , ( "desired start", """New ride time at start: """)
                , ( "desired end", """New ride time at end: """)
                , ( "second", """Seconds""")
                , ( "half", """Half-second""")
                , ( "millis", """Millisecond""")
                , ( "info", """
